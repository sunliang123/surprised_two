...
public class ControllerLogAspect {
	...
	@Pointcut("execution(* com.luomengan.controller..*(..)) and @annotation(org.springframework.web.bind.annotation.RequestMapping)")
	...
	public Object doAround(ProceedingJoinPoint pjp) throws Throwable {
		...
		outputParamMap.put("data", result);
		return result;
	}
	...
	private void printOptLog() {
		...
		try {
			...
			if (outputParamMap.get("data") != null) {
				resultStr.append(mapper.writeValueAsString(outputParamMap.get("data")));
			}
