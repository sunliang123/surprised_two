 ...
 *
 */
public class BaseManageGeneratorService {
	...
	public BaseManageGeneratorService(DataColumnDao dataColumnDao, SkeletonGeneratorService skeleton) {
	...
	private void generateBackCode(Project project, DataObject dataObject) {
		...
		// step 7 : 生成Entity
		FreeMakerUtil.generateFile(backFtlDir + "/entity", "DataObject_Basic.ftl", projectRoot,
