...
<head>
  <meta charset="utf-8" />
  <title>${adminWebTitle}</title>
  <meta name="description" content="${adminWebMetaDescription}" />
  ...
  <link rel="stylesheet" href="vendor/angular/angular-sweet-alert/dist/sweetalert.css" />
...
<body ng-controller="AppCtrl">
  ...
  <script src="vendor/angular/angular-sweet-alert/dist/sweetalert.min.js"></script>
  ...
  <!-- services -->
  <script src="src/js/services/tokenService.js"></script>

  <!-- controllers -->
  <#list dataObjectPojoList as being>
  <script src="src/js/controllers/${being.jsName}.js"></script>
  </#list>
